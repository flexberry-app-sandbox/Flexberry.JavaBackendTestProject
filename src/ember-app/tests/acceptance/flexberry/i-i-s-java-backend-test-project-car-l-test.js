...
moduleForAcceptance('[AGAT] Acceptance | i i s java backend test project car l');

test('testing i-i-s-java-backend-test-project-car-l', function(assert) {
  visit('/i-i-s-java-backend-test-project-car-l');
