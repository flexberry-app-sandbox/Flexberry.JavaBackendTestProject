...
moduleForAcceptance('[AGAT] Acceptance | i i s java backend test project driver l');

test('testing i-i-s-java-backend-test-project-driver-l', function(assert) {
  visit('/i-i-s-java-backend-test-project-driver-l');
